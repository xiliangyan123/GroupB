...
NC2016 <- subdata2016NC %>% select(Cause, Deaths, DeathRate)%>%filter(Cause!="All causes")
...
### Top 2 causes of death in three states  
...
DT::datatable(NNC2016, caption= "Top 2 Causes of Death in three states during the Year 2014 to 2016")
